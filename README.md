...
[![Latest release](https://img.shields.io/github/v/release/ALVINdimpos/my-brand?label=Latest%20release&style=social)](https://github.com/ALVINdimpos/my-brand/releases/tag/v0.1.0)
[![Stars](https://img.shields.io/github/stars/ALVINdimpos/my-brand?style=social)](https://github.com/ALVINdimpos/my-brand/stargazers)
[![Fork](https://img.shields.io/github/forks/ALVINdimpos/my-brand?style=social)](https://github.com/ALVINdimpos/my-brand/forks)
...
[![Top Language](https://img.shields.io/github/languages/top/ALVINdimpos/my-brand?logo=github&logoColor=%23007ACC&label=TypeScript)](https://www.typescriptlang.org/)
[![Contributors](https://img.shields.io/github/contributors/ALVINdimpos/my-brand?style=flat&color=orange&label=Contributors)](https://github.com/ALVINdimpos/my-brand/graphs/contributors)
![Release](https://img.shields.io/github/release/ALVINdimpos/my-brand.svg)
![PRs](https://img.shields.io/badge/PRs-welcome-ff69b4.svg?style=shields)
![deployment](https://img.shields.io/github/deployments/ALVINdimpos/my-brand/Production?logo=vercel&label=Website)
[![Known Vulnerabilities](https://snyk.io/test/github/ALVINdimpos/my-brand/badge.svg)](https://snyk.io/test/github/ALVINdimpos/my-brand)

## 🌐 Live Demo

Explore the live demonstration of the project:
[my-brand](https://alvincoder.com/)
...
```bash
git clone https://github.com/ALVINdimpos/my-brand.git
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FALVINdimpos%2Fmy-brand)

#### Deploy on Netlify

You can also deploy this Next.js app with [Netlify](https://www.netlify.com/).

[![Deploy with Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/ALVINdimpos/my-brand)

Check out [Next.js deployment documentation](https://nextjs.org/docs/deployment) for more details.

## 🔧 Contributing

[![contributors](https://contrib.rocks/image?repo=ALVINdimpos/my-brand)](https://github.com/ALVINdimpos/my-brand/graphs/contributors)
...
[here](https://github.com/ALVINdimpos/my-brand/issues/new) by including the issue with a
title and clear description.

If you'd like to request a new function, feel free to do so by opening an issue
[here](https://github.com/ALVINdimpos/my-brand/issues/new). Please include sample
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-fistonalvin-blue?style=flat&logo=linkedin&logoColor=b0c0c0&labelColor=363D44)](https://www.linkedin.com/in/lironabutbul)
[![Instagram](https://img.shields.io/badge/Instagram-iamalvin250-grey?style=flat&logo=instagram&logoColor=b0c0c0&labelColor=8134af)](https://www.instagram.com/ALVINdimpos)

[![Twitter](https://img.shields.io/twitter/follow/alvincoder.svg?style=social)](https://twitter.com/intent/follow?screen_name=alvincoder) 

## 📋 License

**Three.js 3D Portfolio** is open source software
[licensed as MIT](https://opensource.org/license/mit/) and is free to use — See
[LICENSE](https://github.com/ALVINdimpos/my-brand/blob/main/LICENSE) for more details.
